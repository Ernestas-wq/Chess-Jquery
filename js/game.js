...
function correctMove(player, piece, row, column, targRow, targColumn, targPiece, targPlayer) {
  ...
  // Queen = bishop+rook logic combined
    ...
    // White castling conditions
      ...
      castle(player, row, column, targRow, targColumn) == true &&
      targColumn == 3 &&
      targRow == 1
    ) {
...
function evaluateCheckMate(player) {
  ...
  for (let k = 1; k <= 8; k++) {
    for (let j = 1; j <= 8; j++) {
      ...
      if (
        checkKingMoves(
          piecePositions.king.rows[0],
          piecePositions.king.cols[0],
          evaluatedPlayer,
          k,
          j,
          targPlayer
      ...
      if (
        checkBishopMoves(
          piecePositions.bishop.rows[0],
          piecePositions.bishop.cols[0],
          evaluatedPlayer,
          k,
          j
        ) == true ||
        checkBishopMoves(
          piecePositions.bishop.rows[1],
          piecePositions.bishop.cols[1],
          evaluatedPlayer,
          k,
          j
        ) == true
      ...
      if (
        checkBishopMoves(
          piecePositions.queen.rows[0],
          piecePositions.queen.cols[0],
          evaluatedPlayer,
          k,
          j
        ) == true ||
      ...
      if (
        checkKnightMoves(
          piecePositions.knight.rows[0],
          piecePositions.knight.cols[0],
          evaluatedPlayer,
          k,
          j
        ) == true ||
        checkKnightMoves(
          piecePositions.knight.rows[1],
          piecePositions.knight.cols[1],
          evaluatedPlayer,
          k,
          j
        ) == true
      ...
      if (
        checkRookMoves(
          piecePositions.rook.rows[0],
          piecePositions.rook.cols[0],
          evaluatedPlayer,
          k,
          j
        ) == true ||
        checkRookMoves(
          piecePositions.rook.rows[1],
          piecePositions.rook.cols[1],
          evaluatedPlayer,
          k,
          j
        ) == true
      ...
      for (let p = 0; p < piecePositions.pawn.cols.length; p++) {
        if (
          checkPawnMoves(
            piecePositions.pawn.rows[p],
            piecePositions.pawn.cols[p],
            evaluatedPlayer,
            k,
            j
          ) == true
  ...
  for (let f = 0; f < availableMoves.king.cols.length; f++) {
    if (
      kingInCheck(
        ...
        piecePositions.king.rows[0],
        piecePositions.king.cols[0],
        availableMoves.king.rows[f],
        availableMoves.king.cols[f],
        "king"
      ) == false
    ) {
      legalMoves++;
  ...
  for (let f = 0; f < availableMoves.bishop.cols.length; f++) {
    let targPiece = $(
      "[empty][row='" +
        availableMoves.bishop.rows[f] +
        "'][column='" +
        availableMoves.bishop.cols[f] +
        "']"
    ).attr("piece");
  ...
  for (let f = 0; f < availableMoves.queen.cols.length; f++) {
    let targPiece = $(
      "[empty][row='" +
        availableMoves.queen.rows[f] +
        "'][column='" +
        availableMoves.queen.cols[f] +
        "']"
    ).attr("piece");
    if (typeof targPiece == "undefined") {
      targPiece = "";
  ...
  for (let f = 0; f < availableMoves.knight.cols.length; f++) {
    let targPiece = $(
      "[empty][row='" +
        availableMoves.knight.rows[f] +
        "'][column='" +
        availableMoves.knight.cols[f] +
        "']"
    ).attr("piece");
    if (typeof targPiece == "undefined") {
      targPiece = "";
  ...
  for (let f = 0; f < availableMoves.rook.cols.length; f++) {
    let targPiece = $(
      "[empty][row='" +
        availableMoves.rook.rows[f] +
        "'][column='" +
        availableMoves.rook.cols[f] +
        "']"
    ).attr("piece");
    if (typeof targPiece == "undefined") {
      targPiece = "";
  ...
  for (let f = 0; f < availableMoves.pawn.cols.length; f++) {
    let targPiece = $(
      "[empty][row='" +
        availableMoves.pawn.rows[f] +
        "'][column='" +
        availableMoves.pawn.cols[f] +
        "']"
    ).attr("piece");
    if (typeof targPiece == "undefined") {
      targPiece = "";
    ...
    if (
      kingInCheck(
        evaluatedPlayer,
        piecePositions.pawn.rows[0],
        piecePositions.pawn.cols[0],
        availableMoves.pawn.rows[f],
        availableMoves.pawn.cols[f]
      ) == false
    ) {
...
function evaluteDraw() {
  // Get piece count...
  let pieces = getPieceCount();
  // Draw only possible with <4 pieces...Or if king not in check and legal moves = 0;
}
